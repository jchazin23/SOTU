...
```
Some interesting patterns are revealed here. For example, Kennedy tended to express himself with words associated to the social movements of the sixties, such as freedom, references to the world (as opposed to the nation), and the concept of peace. We also see that Washington is big on the words "United States", without many other concepts standing out, which makes sense when comparing to the results obtained by analyzing the extend of his vocabulary.
...
^1^ Groves, Anna. _First Annual Address to Congress_. www.mountvernon.org.
